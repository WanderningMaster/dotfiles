...
vim.keymap.set('n', '<leader>m', ":'<,'>normal @q")
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader><leader>', vim.lsp.buf.hover, 'Hover Documentation')
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        local ft = { go = true, rust = true }
        return {
          timeout_ms = 500,
          lsp_fallback = ft[vim.bo[bufnr].filetype],
        }
      end,
      formatters_by_ft = {
        lua = { 'stylua' },
